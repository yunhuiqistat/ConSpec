...
You can install the development version of ConSpec from
...
<img src="man/figures/README-eta-tuning-for-cPCA-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="man/figures/README-cPCA-usage-score-plot-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="man/figures/README-scPCA-usage-score-plot-1.png" alt="" style="display: block; margin: auto;" />
...
1.  We load the simulated data from the `data(intro)`, and get the first
    pair of score from 3CA, then we cluster the scores using kmeans
    clustreing with two clusters. We would like to check if these scores
    recover the target specific clusters.
...
<img src="man/figures/README-3CA-usage-1.png" alt="" style="display: block; margin: auto;" />
...
We load the simulated data from the `data(intro)`, and get the first
pair of score from s3CA, then we cluster the scores using kmeans
clustreing with two clusters. We would like to check if these scores
recover the target specific clusters.
...
<img src="man/figures/README-s3CA-usage-1.png" alt="" style="display: block; margin: auto;" />
